export default function TextInfo(){
	return(
		<div className="container mx-auto divide-y-4 divide-black divide-opacity-25">
         ...
         <div className="text-center">
            <h3 className="font-mono text-3xl capitalize hover:text-purple-600">text color</h3> 
          ...
          <div className="text-center">
           <h3 className="font-mono text-3xl capitalize hover:text-blue-600">text opacity</h3>
          ...
          <div className="text-center">
            <h3 className="font-mono text-3xl capitalize hover:text-yellow-600">text transform</h3> 
          ...
          <div className="text-center">
            <h3 className="font-mono text-3xl capitalize hover:text-red-600">text effect hover color</h3>
          ...
          <div className="text-center">
            <h3 className="font-mono text-3xl uppercase text-pink-600 hover:text-white hover:bg-pink-300">Text Effect Hover Background</h3>     
           ...
           <div className="text-center">
              <h3 className="font-mono text-3xl uppercase hover:text-blue-700">Text Effect Hover Opacity</h3> 
